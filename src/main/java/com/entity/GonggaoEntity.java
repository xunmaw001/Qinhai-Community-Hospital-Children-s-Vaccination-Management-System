...
public class GonggaoEntity<T> implements Serializable {
     ...
     * 异常信息名称
     */
    @ColumnInfo(comment="异常信息名称",type="varchar(200)")
     ...
     * 异常信息图片
     */
    @ColumnInfo(comment="异常信息图片",type="varchar(200)")
     ...
     * 异常信息类型
     */
    @ColumnInfo(comment="异常信息类型",type="int(11)")
     ...
     * 异常信息详情
     */
    @ColumnInfo(comment="异常信息详情",type="longtext")
