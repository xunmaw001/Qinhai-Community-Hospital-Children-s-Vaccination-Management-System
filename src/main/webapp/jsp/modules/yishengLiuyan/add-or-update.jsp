    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑提醒接种提</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑提醒接种提</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">提醒接种提信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yisheng">
                                        <label>医生姓名</label>
                                        <input style="width: 450px" id="yishengName" name="yishengName" placeholder="医生姓名" class="form-control" >
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 yonghu">
                                        <label>用户姓名</label>
                                        <input style="width: 450px" id="yonghuName" name="yonghuName" placeholder="用户姓名" class="form-control" >
                                    </div>
                            <!-- 当前表的字段 -->
...
<script>
            ...
            if(window.sessionStorage.getItem('role') != '医生'){//当前登录用户不为这个
                if($("#yishengId") !=null){
                    ...
                    if(yishengId == null || yishengId =='' || yishengId == 'null'){
                        layui.layer.msg("医生不能为空", {time: 2000,icon: 5});
                        return;
                    }
                }
            }
    ...
    function getDetails() {
        ...
        if (addyishengLiuyan != null && addyishengLiuyan != "" && addyishengLiuyan != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='yishengLiuyan'){
    ...
    function yishengShowVideo() {
        $("#yishengPhotoV").attr("src",baseUrl+ruleForm.yishengPhoto);
    }
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="yishengLiuyan"){//个人中心修改
            }
        }
