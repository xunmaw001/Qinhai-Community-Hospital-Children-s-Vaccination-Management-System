...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">提醒接种提管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">提醒接种提管理</li>
                            <li class="breadcrumb-item active">提醒接种提列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">提醒接种提列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="yishengLiuyanExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/yishengLiuyanMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>医生姓名<i id="yishengNameIcon"></i></th>
                                        <th>用户姓名<i id="yonghuNameIcon"></i></th>
                                        <th onclick="sort('yisheng_liuyan_text')">留言内容<i id="yishengLiuyanTextIcon" class="fa fa-sort"></i></th>
    ...
    <script>
        ...
        function upload() {
            /*导入数据*/
            $('#yishengLiuyanExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("yishengLiuyan/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("yishengLiuyan/update", "POST", {
                    id:id,
                    yishengLiuyanTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
