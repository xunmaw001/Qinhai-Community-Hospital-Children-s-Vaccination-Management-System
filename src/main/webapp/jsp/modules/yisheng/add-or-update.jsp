                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yishengPhoneDiv">
                                        <label>医生手机号</label>
                                        <input style="width: 450px" id="yishengPhone" name="yishengPhone" class="form-control"
                                               onchange="yishengPhoneChickValue(this)"  placeholder="医生手机号">
                                    </div>
                                    <div class="form-group col-md-6 yishengIdNumberDiv">
                                        <label>医生身份证号</label>
                                        <input style="width: 450px" id="yishengIdNumber" name="yishengIdNumber" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 yishengEmailDiv">
                                        <label>医生邮箱</label>
                                        <input style="width: 450px" id="yishengEmail" name="yishengEmail" class="form-control"
                                               placeholder="医生邮箱">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        $('#yishengPhotoupload').fileupload({
            ...
            dataType: 'json',
                ...
                document.getElementById('yishengPhotoImg').setAttribute('src',baseUrl+photoUrl);
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                yishengPhoto: "医生头像不能为空",
                sexTypes: "性别不能为空",
                yishengEmail: "医生邮箱不能为空",
            }
        }).form();
    }
    ...
    function getDetails() {
        ...
        if (addyisheng != null && addyisheng != "" && addyisheng != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='yisheng'){
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#yishengEmail").val(ruleForm.yishengEmail);
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#yishengPhotoImg").attr("src",baseUrl+ruleForm.yishengPhoto);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            if(sessionTable=="yisheng"){//个人中心修改
            }
        }
