...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="yishengExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/yishengMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('yisheng_name')">医生姓名<i id="yishengNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yisheng_phone')">医生手机号<i id="yishengPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yisheng_id_number')">医生身份证号<i id="yishengIdNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yisheng_photo')">医生头像<i id="yishengPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('sex_types')">性别<i id="sexTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('yisheng_email')">医生邮箱<i id="yishengEmailIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            var yishengPhotoImgValue = baseUrl+item.yishengPhoto;
            ...
            //医生邮箱
            var yishengEmailCell = document.createElement('td');
            yishengEmailCell.innerHTML = item.yishengEmail;
            row.appendChild(yishengEmailCell);
        ...
        function upload() {
            /*导入数据*/
            $('#yishengExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("yisheng/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
