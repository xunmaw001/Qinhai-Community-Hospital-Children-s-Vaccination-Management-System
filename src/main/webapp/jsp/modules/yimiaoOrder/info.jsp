            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">疫苗预约登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yimiaoOrderUuidNumber" name="yimiaoOrderUuidNumber" class="form-control"
                                               v-model="ruleForm.yimiaoOrderUuidNumber" readonly>
                                    </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yimiaoOrderTruePrice" name="yimiaoOrderTruePrice" class="form-control"
                                               v-model="ruleForm.yimiaoOrderTruePrice" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>预约时间</label>
                                        <input style="width: 450px" id="yimiaoOrderTime" name="yimiaoOrderTime" class="form-control"
                                               v-model="ruleForm.yimiaoOrderTime" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>订单类型</label>
                                    <input style="width: 450px" id="yimiaoOrderValue" name="yimiaoOrderValue" class="form-control"
                                           v-model="ruleForm.yimiaoOrderValue" readonly>
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yimiaoOrder/info/" + id,
