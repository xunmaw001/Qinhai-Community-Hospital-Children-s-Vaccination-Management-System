        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">异常信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">异常信息管理</li>
                            <li class="breadcrumb-item active">异常信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">异常信息列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                                                         
                                        <label>异常信息名称</label>
                                        <input type="text" id="gonggaoNameSearch" placeholder="请输入异常信息名称" aria-controls="tableId" class="form-control form-control-sm">
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('gonggao_name')">异常信息名称<i id="gonggaoNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gonggao_photo')">异常信息图片<i id="gonggaoPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gonggao_types')">异常信息类型<i id="gonggaoTypesIcon" class="fa fa-sort"></i></th>
