    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑异常信息</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑异常信息</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">异常信息信息</h3>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                gonggaoName: "异常信息名称不能为空",
                gonggaoPhoto: "异常信息图片不能为空",
                gonggaoTypes: "异常信息类型不能为空",
                gonggaoContent: "异常信息详情不能为空",
            }
        }).form();
    }
