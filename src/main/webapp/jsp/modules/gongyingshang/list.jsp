...
<!--/Pre Loader -->
                        ...
                        <div class="widget-area-2 lochana-box-shadow">
                            ...
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <label>联系人姓名</label>
                                        <input type="text" id="lianxirenNameSearch" placeholder="请输入联系人姓名" aria-controls="tableId" class="form-control form-control-sm">
                                                                                                                                                 
                                        <label>信用等级</label>
                                        <select name="gongyingshangXinyongdengjiTypesSelectSearch" id="gongyingshangXinyongdengjiTypesSelectSearch" aria-controls="tableId" class="form-control form-control-sm"></select>
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="gongyingshangExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/gongyingshangMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th onclick="sort('gongyingshang_uuid_number')">供应商唯一编号<i id="gongyingshangUuidNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gongyingshang_name')">供应商名称<i id="gongyingshangNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('lianxiren_name')">联系人姓名<i id="lianxirenNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('lianxiren_phone')">联系人手机号<i id="lianxirenPhoneIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('lianxiren_address')">地址<i id="lianxirenAddressIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gongyingshang_types')">供应商类型<i id="gongyingshangTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('gongyingshang_xinyongdengji_types')">信用等级<i id="gongyingshangXinyongdengjiTypesIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //地址
            var lianxirenAddressCell = document.createElement('td');
            lianxirenAddressCell.innerHTML = item.lianxirenAddress;
            row.appendChild(lianxirenAddressCell);
            ...
            //信用等级
            var gongyingshangXinyongdengjiTypesCell = document.createElement('td');
            gongyingshangXinyongdengjiTypesCell.innerHTML = item.gongyingshangXinyongdengjiValue;
            row.appendChild(gongyingshangXinyongdengjiTypesCell);
        ...
        function upload() {
            /*导入数据*/
            $('#gongyingshangExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("gongyingshang/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("gongyingshang/update", "POST", {
                    id:id,
                    gongyingshangTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
