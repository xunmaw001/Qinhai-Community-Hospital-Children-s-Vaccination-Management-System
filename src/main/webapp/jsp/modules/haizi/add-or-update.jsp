    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑孩子信息</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑孩子信息</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">孩子信息信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 haiziNameDiv">
                                        <label>孩子姓名</label>
                                        <input style="width: 450px" id="haiziName" name="haiziName" class="form-control"
                                               placeholder="孩子姓名">
                                    </div>
                                    <div class="form-group col-md-6 haiziIdNumberDiv">
                                        <label>孩子身份证号</label>
                                        <input style="width: 450px" id="haiziIdNumber" name="haiziIdNumber" class="form-control"
                                               onchange="haiziIdNumberChickValue(this)"  placeholder="孩子身份证号">
                                    </div>
                                    <div class="form-group col-md-6 haiziPhotoDiv">
                                        <label>孩子头像</label>
                                        <img id="haiziPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="haiziPhotoupload"
                                               class="form-control-file">
                                        <input name="haiziPhoto" id="haiziPhoto-input" type="hidden">
                                    </div>
                                    ...
                                    <div class="form-group col-md-6 haiziNianlingDiv">
                                        <label>年龄</label>
                                        <input style="width: 450px" id="haiziNianling" name="haiziNianling" class="form-control"
                                               onchange="integerChickValue(this)"  placeholder="年龄">
                                    </div>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#haiziPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= 'file/download?fileName=' + data.result.file;
                document.getElementById('haiziPhotoImg').setAttribute('src',baseUrl+photoUrl);
                document.getElementById('haiziPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("haizi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addhaizi');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                yonghuId: "required",
                haiziName: "required",
                haiziIdNumber: "required",
                haiziPhoto: "required",
                sexTypes: "required",
                haiziNianling: "required",
            },
            messages: {
                yonghuId: "用户不能为空",
                haiziName: "孩子姓名不能为空",
                haiziIdNumber: "孩子身份证号不能为空",
                haiziPhoto: "孩子头像不能为空",
                sexTypes: "性别不能为空",
                haiziNianling: "年龄不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addhaizi = window.sessionStorage.getItem("addhaizi");
        if (addhaizi != null && addhaizi != "" && addhaizi != "null") {
            //注册表单验证
            $(validform());
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#haiziName").val(ruleForm.haiziName);
        $("#haiziIdNumber").val(ruleForm.haiziIdNumber);
        $("#haiziNianling").val(ruleForm.haiziNianling);
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#haiziPhotoImg").attr("src",baseUrl+ruleForm.haiziPhoto);
