...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">孩子信息管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">孩子信息管理</li>
                            <li class="breadcrumb-item active">孩子信息列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">孩子信息列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                                                                                             
                                        <label>孩子姓名</label>
                                        <input type="text" id="haiziNameSearch" placeholder="请输入孩子姓名" aria-controls="tableId" class="form-control form-control-sm">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="haiziExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/haiziMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>余额<i id="newMoneyIcon"></i></th>
                                        <th onclick="sort('haizi_name')">孩子姓名<i id="haiziNameIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('haizi_id_number')">孩子身份证号<i id="haiziIdNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('haizi_photo')">孩子头像<i id="haiziPhotoIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('sex_types')">性别<i id="sexTypesIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('haizi_nianling')">年龄<i id="haiziNianlingIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //孩子姓名
            var haiziNameSearchInput = $('#haiziNameSearch');
            if( haiziNameSearchInput != null){
                if (haiziNameSearchInput.val() != null && haiziNameSearchInput.val() != '') {
                    searchForm.haiziName = $('#haiziNameSearch').val();
                }
            }
                                getDataList();
        }
        ...
        function getDataList() {
            http("haizi/page", "GET", {
                ...
                haiziDelete: 1,
                //本表的
                haiziName: searchForm.haiziName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //孩子姓名
            var haiziNameCell = document.createElement('td');
            haiziNameCell.innerHTML = item.haiziName;
            row.appendChild(haiziNameCell);


            //孩子身份证号
            var haiziIdNumberCell = document.createElement('td');
            haiziIdNumberCell.innerHTML = item.haiziIdNumber;
            row.appendChild(haiziIdNumberCell);

                //孩子头像
            var haiziPhotoCell = document.createElement('td');
            var haiziPhotoImg = document.createElement('img');
            var haiziPhotoImgValue = baseUrl+item.haiziPhoto;
            if(haiziPhotoImgValue !=null && haiziPhotoImgValue !='' && haiziPhotoImgValue !='null'){
                haiziPhotoImg.setAttribute('src', haiziPhotoImgValue);
                haiziPhotoImg.setAttribute('height', 100);
                haiziPhotoImg.setAttribute('width', 100);
                haiziPhotoCell.appendChild(haiziPhotoImg);
            }else{
                haiziPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(haiziPhotoCell);
            ...
            //年龄
            var haiziNianlingCell = document.createElement('td');
            haiziNianlingCell.innerHTML = item.haiziNianling;
            row.appendChild(haiziNianlingCell);
        ...
        function upload() {
            /*导入数据*/
            $('#haiziExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("haizi/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("haizi/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addhaizi", "addhaizi");
            window.location.href = "add-or-update.jsp"
        }
