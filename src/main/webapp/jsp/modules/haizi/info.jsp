            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">孩子信息登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="haiziName" name="haiziName" class="form-control"
                                               v-model="ruleForm.haiziName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="haiziIdNumber" name="haiziIdNumber" class="form-control"
                                               v-model="ruleForm.haiziIdNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>孩子头像</label>
                                    <img id="haiziPhotoImg" width="100" height="100">
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="haiziNianling" name="haiziNianling" class="form-control"
                                               v-model="ruleForm.haiziNianling" readonly>
                                    </div>
