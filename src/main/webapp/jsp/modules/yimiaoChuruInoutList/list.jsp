...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">出入库详情管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">出入库详情列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">出入库详情列表</h3>
                            <div class="table-responsive mb-3" id="tableDiv">
                                <div class="col-sm-12">
                                        ...
                                        <span class="导入导出">
                                            导入<input name="file" id="yimiaoChuruInoutListExcelFile" type="file" class="btn btn-success" style="width: 70px!important; line-height: 35px;">
                                            <button class="btn btn-success" onclick="download('/upload/yimiaoChuruInoutListMuBan.xls')">导入模板下载</button>
                                        </span>
                                ...
                                <table id="tableId" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>疫苗编号<i id="yimiaoUuidNumberIcon"></i></th>
                                        <th>疫苗照片<i id="yimiaoPhotoIcon"></i></th>
                                        <th>金额<i id="yimiaoNewMoneyIcon"></i></th>
                                        <th>疫苗类型<i id="yimiaoTypesIcon"></i></th>
                                        <th>出入库流水号<i id="yimiaoChuruInoutUuidNumberIcon"></i></th>
                                        <th>出入库名称<i id="yimiaoChuruInoutNameIcon"></i></th>
                                        <th>出入库类型<i id="yimiaoChuruInoutTypesIcon"></i></th>
                                        <th onclick="sort('yimiao_churu_inout_list_number')">操作数量<i id="yimiaoChuruInoutListNumberIcon" class="fa fa-sort"></i></th>
                                        <th onclick="sort('insert_time')">操作时间<i id="insertTimeIcon" class="fa fa-sort"></i></th>
                                        <th>操作</th>
                                    </tr>
                                    </thead>
                                    <tbody id="thisTbody">
    ...
    <script>
        ...
        function upload() {
            /*导入数据*/
            $('#yimiaoChuruInoutListExcelFile').fileupload({
                url: baseUrl + 'file/upload',
                headers: {token: window.sessionStorage.getItem("token")},
                dataType: "json",
                done: function (e, data) {
                    http("yimiaoChuruInoutList/batchInsert?fileName="+data.result.file, "get", {} , (res) => {
                        if(res.code == 0){
        ...
        function wuyong(id) {
            ...
            if (mymessage == true) {
                httpJson("yimiaoChuruInoutList/update", "POST", {
                    id:id,
                    yimiaoChuruInoutListTypes:2
                }, (res) => {
                    if(res.code == 0){
                        getDataList();
                        layui.layer.msg("操作成功", {time: 2000,icon: 6});
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addyimiaoChuruInoutList", "addyimiaoChuruInoutList");
            window.location.href = "add-or-update.jsp"
        }
        function exportExcel() {
            excel = new ExcelGen({
                "src_id": "tableId",
                "show_header": true,
                "file_name": 'yimiaoChuruInoutList.xlsx'
            });
            excel.generate();
        }
...
// 101 102 103 104 105
            ...
            function chartDialog(){
                ...
                //    groupColumn: "yimiao_churu_inout_list_types",
                //    // riqi:echartsDate
                //}, (res) => {//pieSum pieCount
                //    if (res && res.code === 0) {
                //        let data = res.data;
