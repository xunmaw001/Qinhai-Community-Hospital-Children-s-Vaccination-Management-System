            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">出入库详情登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="yimiaoName" name="yimiaoName" class="form-control"
                                                   v-model="ruleForm.yimiaoName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="yimiaoUuidNumber" name="yimiaoUuidNumber" class="form-control"
                                                   v-model="ruleForm.yimiaoUuidNumber" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>疫苗照片</label>
                                        <img id="yimiaoPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>金额</label>
                                            <input style="width: 450px" id="yimiaoNewMoney" name="yimiaoNewMoney" class="form-control"
                                                   v-model="ruleForm.yimiaoNewMoney" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>疫苗类型</label>
                                        <input style="width: 450px" id="yimiaoValue" name="yimiaoValue" class="form-control"
                                               v-model="ruleForm.yimiaoValue" readonly>
                                    </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yimiaoChuruInoutId" name="yimiaoChuruInoutId" v-model="ruleForm.yimiaoChuruInoutId" readonly type="hidden">
                                <input id="yimiaoId" name="yimiaoId" v-model="ruleForm.yimiaoId" readonly type="hidden">

                                    <div class="form-group col-md-6">
                                        <label>操作数量</label>
                                        <input style="width: 450px" id="yimiaoChuruInoutListNumber" name="yimiaoChuruInoutListNumber" class="form-control"
                                               v-model="ruleForm.yimiaoChuruInoutListNumber" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "yimiaoChuruInoutList/info/" + id,
