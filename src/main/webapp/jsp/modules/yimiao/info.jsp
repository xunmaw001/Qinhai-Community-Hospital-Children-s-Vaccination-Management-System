            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">疫苗登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="gongyingshangUuidNumber" name="gongyingshangUuidNumber" class="form-control"
                                                   v-model="ruleForm.gongyingshangUuidNumber" readonly>
                                        </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>供应商类型</label>
                                        <input style="width: 450px" id="gongyingshangValue" name="gongyingshangValue" class="form-control"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yimiaoAddress" name="yimiaoAddress" class="form-control"
                                               v-model="ruleForm.yimiaoAddress" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="yimiaoKucunNumber" name="yimiaoKucunNumber" class="form-control"
                                               v-model="ruleForm.yimiaoKucunNumber" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.yimiaoContent != null && ruleForm.yimiaoContent != 'null' && ruleForm.yimiaoContent != '') {
            var yimiaoContentUeditor = UE.getEditor('yimiaoContentEditor');
                yimiaoContentUeditor.ready(function () {
                    ...
                    yimiaoContentUeditor.setDisabled('fullscreen');
            });
        }
    }
