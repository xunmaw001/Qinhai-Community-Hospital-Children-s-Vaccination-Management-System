                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <div class="form-group col-md-6 forumNameDiv">
                                    <label>帖子标题</label>
                                    <input style="width: 450px" id="forumName" name="forumName" placeholder="帖子标题" class="form-control">
                                </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        function initializationForumStateTypesSelect(){
            ...
            if(forumStateTypesSelect != null && forumStateTypesOptions != null  && forumStateTypesOptions.length > 0 ){
                forumStateTypesSelect.options.length=0;
    ...
    function getContent() {
        ...
        if($("#forumContentupload").length>0) {
            ...
            if (forumContentEditor.hasContents()) {
                $('#forumContent-input').attr('value', forumContentEditor.getContent().replaceAll(baseUrl,""));
            }
        }
    }
    function jiaofei() {
    ...
    function getDetails() {
        ...
        if (addforum != null && addforum != "" && addforum != "null") {
            ...
            $('#submitBtn').text('修改');
            if(window.sessionStorage.getItem('accountTableName') =='forum'){
