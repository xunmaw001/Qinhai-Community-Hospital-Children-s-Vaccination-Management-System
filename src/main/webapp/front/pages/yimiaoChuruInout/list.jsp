    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.yimiaoChuruInoutName" placeholder="出入库名称" autocomplete="off"
                       class="search-input">     
                                <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        <div id="btn-search" class="button-submit"><i class="layui-icon layui-icon-search"></i>搜索</div>
                        <div v-if="isAuth('yimiaoChuruInout','新增')"  @click="jump('../yimiaoChuruInout/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
                <div class="tags tags1">
                    ...
                    <ul>
                        <li class="thisTableType-search">
                            <a :class='searchForm.yimiaoChuruInoutTypes=="" || searchForm.yimiaoChuruInoutTypes==null?"thisTableType-search-hover":""'>全部</a>
                        </li>
                        <li v-for="(item,index) in yimiaoChuruInoutTypesList" :key="item.codeIndex" :index="item.codeIndex" class="thisTableType-search" >
                            <a :class='searchForm.yimiaoChuruInoutTypes==item.codeIndex?"thisTableType-search-hover":""'>{{item.indexName}}</a>
                        </li>
                    </ul>
                </div>
            </div>
