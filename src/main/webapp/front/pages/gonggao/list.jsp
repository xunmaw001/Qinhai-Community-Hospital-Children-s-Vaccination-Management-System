    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div style="width: 760px;margin-top: 13px">
                            <div style="position: relative;display: flex;justify-content: space-evenly;flex-wrap: wrap;">
    <div @click="jump('../gonggao/detail.jsp?id='+item.id);" v-for="(item,index) in dataList"
         :key="index" class="list-item4 list-item3B" style="padding: 0 4px">
        <div class="animation-box" :style='{"padding":"0","boxShadow":"0px 3px 6px rgba(0, 0, 0, 0.16)","margin":"0 0 10px 0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","borderRadius":"20px","borderWidth":"20px 0 0","borderStyle":"solid"}'>
            <img :style='{"boxShadow":"0 0 0px rgba(255,0,0,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"25px","borderWidth":"0","width":"100%","borderStyle":"solid","height":"200px"}'
                 :src="baseUrl+item.gonggaoPhoto">
            <div>
                <div :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}'
                >{{item.gonggaoName}}
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.gonggaoName" placeholder="异常信息名称" autocomplete="off"
                       class="search-input">         
...
//                    gonggaoTypes:1,
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery', 'laydate', 'tinymce'], function() {
        ...
        $(document).on("click", ".thisTableType-search", function (e) {
            ...
            //当前表的 异常信息类型 字段 字典表查询
            gonggaoTypesSelect();
                                           //当前表的 异常信息类型 字段 字典表查询方法
