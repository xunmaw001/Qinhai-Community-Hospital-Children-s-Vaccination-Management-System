            ...
            <div style="width: 90%;margin: 0 auto;border: 1px solid #f3f3f3;margin-top: 15px;"
                ...
                <div
                    ...
                    <div style="margin-left: 50px;">
                        订单编号:{{item.yimiaoOrderUuidNumber}}
                    </div>
                    <div style="margin-left: 50px;" v-if="item.yimiaoOrderTypes != 101 && item.yimiaoOrderTypes != 102 && item.yimiaoOrderCourierName != null">
                        {{item.yimiaoOrderCourierName}}：{{item.yimiaoOrderCourierNumber}}
                    </div>
                ...
                <div style="display: flex;">
                    <div style="width: 60%;display: flex;">
                        <div style="display: flex;">
                            <img :src="baseUrl+item.yimiaoPhoto"
                    ...
                    <div style="width: 10%;margin: 15px;">
                        {{item.yimiaoOrderTruePrice}}
                        <div>{{item.yimiaoOrderPaymentValue}}</div>
                    </div>
                    <div style="width: 10%;margin: 15px;">
                        {{item.yimiaoOrderValue}}
                    </div>
                    <div style="width: 10%;margin: 15px;">
