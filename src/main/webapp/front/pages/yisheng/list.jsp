    ...
    <div class="container py-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.yishengName" placeholder="医生姓名" autocomplete="off"
                       class="search-input">                                            <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        ...
                        <div v-if="isAuth('yisheng','新增')"  @click="jump('../yisheng/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
            </div>
        </div>
