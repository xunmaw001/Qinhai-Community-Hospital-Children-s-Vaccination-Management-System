        ...
        <div class="row">
            ...
            <div style="width: 760px;margin-top: 13px">
                    ...
                    <div class="show-reel row" style="display: flex;justify-content: space-around;">
                        <div v-for="(item,index) in dataList" v-bind:key="index" class="list-item4 list-item3B" style="padding: 6px">
            ...
            <div class="col-lg-4 event-right wthree-event-right">
                ...
                <input type="text" v-model="searchForm.yimiaoName" placeholder="疫苗名称" autocomplete="off"
                       class="search-input">                         
                                    <div style="display: flex;justify-content: space-evenly;align-items: center;">
                        <div id="btn-search" class="button-submit"><i class="layui-icon layui-icon-search"></i>搜索</div>
                        <div v-if="isAuth('yimiao','新增')"  @click="jump('../yimiao/add.jsp')" class="button-submit"><i class="layui-icon">&#xe654;</i>添加</div>
                    </div>
                </form>
                <div class="tags tags1">
                    ...
                    <ul>
                        <li class="thisTableType-search">
                            <a :class='searchForm.yimiaoTypes=="" || searchForm.yimiaoTypes==null?"thisTableType-search-hover":""'>全部</a>
                        </li>
                        <li v-for="(item,index) in yimiaoTypesList" :key="item.codeIndex" :index="item.codeIndex" class="thisTableType-search" >
                            <a :class='searchForm.yimiaoTypes==item.codeIndex?"thisTableType-search-hover":""'>{{item.indexName}}</a>
                        </li>
                    </ul>
                </div>
            </div>
