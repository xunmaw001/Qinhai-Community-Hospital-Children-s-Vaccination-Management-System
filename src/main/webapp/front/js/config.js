var projectName = '亲海社区医院儿童预防接种管理系统';
/**
 * 轮播图配置
 */
var swiper = {
...
var centerMenu = [
    ...
    ,{
        name: '疫苗预约',
        url: '../yimiaoOrder/list.jsp'
    }
    ,{
        name: '提醒接种提',
        url: '../yishengLiuyan/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '疫苗',
        url: './pages/yimiao/list.jsp'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/qhsqyyetyfjzglxt/admin/dist/index.jsp#/login";
